...
public class OrderMagerActivity extends BaseActivity {
    ...
    private MagerOrderAdapter mEvnetMyAdapter;
    private List<OrderBean> mEventList = new ArrayList<>();

    //    private SysYue parkListBean;
    @Override
    protected void onInitView(Bundle bundle) {
        titleLayout.setTitleText("Order Management");
...
//        }
        ...
        mEvnetMyAdapter = new MagerOrderAdapter(R.layout.item_mager_order, mEventList, new MagerOrderAdapter.OnOverClickLister() {
            @Override
...
//        });
    ...
    private void toOver(OrderBean sysYue) {
        ...
        parameters.put("state", sysYue.getoState());
    ...
    public void toService() {
        ...
        Map<String, Object> parameters = new HashMap<>();
        parameters.put("sellerId", MyApp.getApp().getUser().getUserId() + "");
                        ...
                        if (isSuccess && !TextUtils.isEmpty(response)) {
                            ...
                            if (message != null) {
                                if (message.getCode() == 200) {
                                    ...
                                    ToastUtil.showShort(mContext, "no");
                                }
