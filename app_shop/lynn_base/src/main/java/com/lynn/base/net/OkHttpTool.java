...
public class OkHttpTool {
    ...
    //
    public static String BASE_IP = "192.168.64.1";
    public static String Base_URL = "http://" + BASE_IP + ":8015/";
//    public static String Base_URL = "http://192.168.1.105:8015/";
//    public static String Base_URL = "http://localhost:80/";
    ...
    static {
        ...
        myOkHttpClient = new OkHttpClient.Builder()
                .connectTimeout(1200, TimeUnit.SECONDS)//连接超时
                .writeTimeout(1200, TimeUnit.SECONDS)//写入超时
                .readTimeout(1200, TimeUnit.SECONDS)//读取超时
